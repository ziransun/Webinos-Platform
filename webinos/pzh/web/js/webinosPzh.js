  ...
  commands: {
    ...
    logout: function(){
      ...
      if (window.location.search && window.location.search.split("?") && 
        window.location.search.split("?")[1].split('=')[1] === 'google') {
    ...
    redirect: function(){
      console.log(document.getElementById("ownUrl").value);
      webinosPZH.send({cmd:'redirect', url: document.getElementById("ownUrl").value});
    }
  }
};
