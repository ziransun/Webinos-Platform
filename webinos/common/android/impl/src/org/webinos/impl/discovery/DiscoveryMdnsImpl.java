...
public class DiscoveryMdnsImpl extends DiscoveryManager implements IModule {
	...
	private String ptl_type = "_pzp._tcp.local.";
	...
	public synchronized PendingOperation findServices(
		...
		//TODO: use serviceType.api to pass the type string - generic use
		/*	if(serviceType == null) {
	...
	public void stopModule() {
		...
		//TODO: Add endDiscovery API and move the following lines to this API
		if(mZeroconf != null)
		{	
			Log.v(TAG, "clean up");
			//clean up
